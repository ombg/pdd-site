...
class PublicUserApiTests(TestCase):
    ...
    # The following tests are still part of the authentication process,
    # hence they are part of the test of the Public API.
    def test_create_token_for_user(self):
        ...
        # The token will be validated by Django.
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        """Create and authenticate a user for every test case."""
    ...
    def test_retrieve_profile_success(self):
        ...
        })  # Password should not be part of the response.
